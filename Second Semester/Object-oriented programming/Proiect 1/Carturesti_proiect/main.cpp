...
public:
    ...
    const float getBuget()const{return buget;}
    const int getnrVouchere()const{return nrVouchere;}
    const string getpreferinta()const{return preferinta;}
    const float* getvoucher() const {return this->voucher;}

    void setBuget(float buget){this->buget=buget;}
    void setNrVouchere(int nrVouchere) {this->nrVouchere=nrVouchere;}
    void setPreferinta(string preferinta) {this->preferinta=preferinta;}
    void setVoucher(float* voucher);
...
void Clienti::setVoucher(float* voucher)
{
    if(this->voucher != NULL){
        delete[] this->voucher;
        this->voucher = NULL;
    }
    this->voucher = new float[this->nrVouchere];
    for(int i = 0 ; i < this->nrVouchere ; i++)
...
ostream& operator <<(ostream& out,const Clienti& obj)
{
    ...
    for(int i = 0; i < obj.nrVouchere; i++)
        out << obj.voucher[i] << " ";
    out << endl;
    out<<"Preferinta produs: "<<obj.preferinta<<endl;
    return out;
}
...
public:
    ...
    void setCategorieCarte(char categorieCarte){this->categorieCarte=categorieCarte;}
    void setPretCarte(int pretCarte){this->pretCarte=pretCarte;}
    void setStocCarte(bool stocCarte){this->stocCarte=stocCarte;}
    void setInventarCarte(int inventarCarte){this->inventarCarte=inventarCarte;}
    void setTitluCarte(char* setTitluCarte);
...
void Carti::setTitluCarte(char* titluCarte)
{
...
Carti Carti::operator+(Clienti& obj)
{
    Carti copie(*this);
    if (obj.getpreferinta() == copie.titluCarte)
        copie.inventarCarte--;
    return copie;
}
...
Carti::Carti():idCarte(contorIdCarte++)
{
    ...
    autorCarte = new char[strlen("Anonim") + 1];
    strcpy(autorCarte, "Anonim");
    categorieCarte = '-';
    pretCarte = 0;
    stocCarte = false;
    inventarCarte=0;
...
class Boardgames
{
 ...
 public:
    ...
    Boardgames operator+(Clienti& obj);
    ...
    void setCategorieVarsta(int categorieVarsta){this->categorieVarsta=categorieVarsta;}
    void setPretJoc(int pretJoc){this->pretJoc=pretJoc;}
    void setStocJoc(bool stocJoc){this->stocJoc=stocJoc;}
    void setInventarJoc(int inventarJoc){this->inventarJoc=inventarJoc;}
    void setNumeJoc(char * numeJoc);
...
void Boardgames::setNumeJoc(char* numeJoc)
{
...
Boardgames Boardgames::operator+(Clienti& obj)
{
    Boardgames copie(*this);
    if (obj.getpreferinta() == copie.numeJoc)
        copie.inventarJoc--;
    return copie;
}
...
public:
    ...
    void setCategorieProdus(string categorieProdus){this->categorieProdus=categorieProdus;}
    void setPretMuzica(int pretMuzica){this->pretMuzica=pretMuzica;}
    void setStocMuzica(bool stocMuzica){this->stocMuzica=stocMuzica;}
    void setInventarMuzica(int inventarMuzica){this->inventarMuzica=inventarMuzica;}
    void setTitluProdus(char* titluProdus);

    //Destructor
    ~Muzica();
};

void Muzica::setTitluProdus(char* titluProdus)
{
...
Muzica Muzica::operator+(Clienti& obj)
{
    Muzica copie(*this);
    if (obj.getpreferinta() == copie.titluProdus)
        copie.inventarMuzica--;
    return copie;
}
...
int main()
{
    ...
    do
    {
        ...
        cout << "4. Parasiti libraria noastra" << endl;
        ...
        case 1:
        {
            ...
            do
            {
                ...
                cout << "5. Parasiti categoria de carti" << endl;
                cout << endl << "Enter your choice: ";
                cin >> choice;
                cout << endl;
                ...
                case 1:
                {
                    ...
                    {
                        cout<<"Aveti buget pentru a cumpara cartea '"<<listaCarti[0].getTitluCarte()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                        cout<<"Nu aveti buget pentru a cumpara cartea '"<<listaCarti[0].getTitluCarte()<<"'"<<endl<<endl;
                ...
                case 2:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara cartea '"<<listaCarti[1].getTitluCarte()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 3:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara cartea '"<<listaCarti[2].getTitluCarte()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 4:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara cartea '"<<listaCarti[3].getTitluCarte()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
        ...
        case 2:
        {
            ...
            do
            {
                ...
                cout << "5. Parasiti categoria de boardgames" << endl;
                cout << endl << "Enter your choice: ";
                cin >> choice;
                cout << endl;
                ...
                case 1:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara jocul '"<<listaBoardgames[0].getNumeJoc()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                        cout<<"Nu aveti buget pentru a cumpara jocul '"<<listaBoardgames[0].getNumeJoc()<<"'"<<endl<<endl;
                ...
                case 2:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara jocul '"<<listaBoardgames[1].getNumeJoc()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                ...
                case 3:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara jocul '"<<listaBoardgames[2].getNumeJoc()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 4:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara jocul '"<<listaBoardgames[3].getNumeJoc()<<"'"<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
        ...
        case 3:
        {
            ...
            do
            {
                ...
                cout << "5. Parasiti categoria de muzica" << endl;
                cout << endl << "Enter your choice: ";
                cin >> choice;
                cout << endl;
                ...
                case 1:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara "<<listaMuzica[0].getcategorieProdus()<<" '"<<listaMuzica[0].getTitluProdus()<<"' "<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 2:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara "<<listaMuzica[1].getcategorieProdus()<<" '"<<listaMuzica[1].getTitluProdus()<<"' "<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 3:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara "<<listaMuzica[2].getcategorieProdus()<<" '"<<listaMuzica[2].getTitluProdus()<<"' "<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
                ...
                case 4:
                {
                    ...
                    if (x.getBuget() > pretnou)
                    {
                        cout<<"Aveti buget pentru a cumpara "<<listaMuzica[3].getcategorieProdus()<<" '"<<listaMuzica[3].getTitluProdus()<<"' "<<endl;
                        x.setBuget(x.getBuget()-pretnou);
                        cout<<"Bugetul ramas este de "<<x.getBuget()<<" lei"<<endl<<endl;
                    }
                    else
